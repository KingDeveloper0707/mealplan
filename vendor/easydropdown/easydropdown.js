! function(e, t) {
    ...
    return function(e) {
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.getTotalMatching = o, t.default = function(e, t, n, i) {
            ...
            var r = function(e, t, n, i) {
                    var r = o(i.toLowerCase(), e),
                        a = Math.abs(i.length - t.length);
                    return r > n.totalMatching || r === n.totalMatching && a < n.delta ? {
                        key: i,
                        delta: a,
                        totalMatching: r
                    } : n
                }.bind(null, n, n.toLowerCase()),
                a = {
                    key: "",
                    delta: 1 / 0,
                    totalMatching: 0
        ...
        t.mapCollisionData = r, t.default = function(e, t) {
            ...
            return r(u, s, e.sumItemsHeight(l), e.sumItemsHeight(1))
        }
    }, function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
        ...
        t.default = function(e, t, n) {
            var r = e.keyCode,
                ...
                u = t.timers,
                s = t.state;
            void 0 === n && (n = i), s.isUseNativeMode || [o.UP, o.DOWN].includes(r) || (window.clearTimeout(u.searchTimeoutId), a.search(), u.searchTimeoutId = window.setTimeout(function() {
...
//            console.log("ttt=");
//            console.log(t);
//            console.log('t_label = ' + t.label + 't_badge_index = ' + t.badgeIndex);
            var str_badge = (e.value == t.badgeIndex) ? "<span class='badge'>Current Week</span>" : "";
            return '\n        <div\n            class="' + o.default([n.option, [i, n.optionSelected],
                [e === t.focusedOption, n.optionFocused],
                [e.isDisabled, n.optionDisabled]
            ]) + '"\n            data-ref="option item"\n            role="option"\n            title="' + e.label + '"\n            ' + (i ? 'aria-selected="true"' : "") + "\n            " + (e.isDisabled ? 'aria-disabled="true"' : "") + "\n            >\n                <span class='label'>" + e.label + "</span>" + str_badge + "\n        </div>\n    "
        }
    }, function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
        ...
        t.default = function(e, t) {
            return '<div class="' + t.arrow + '" role="presentation"><svg class="icon" width="28" height="28" color="#224390" ><use xlink:href="#angle-down"></use></svg></div>'
        }
    }, function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
