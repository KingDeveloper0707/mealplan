<div id="summary-section-area">
    <section id="summary">
        <div class="container shadow-container">
            <div class="row mb-5">
                <div class="col-12" style="padding-top: 5rem;">
                    <p class="p-first-name blue-color proxima-nova-bold">Hello <span class="first_name">Hannah</span>, your results are in!</p>
                    <h2>PROFILE SUMMARY</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="container inner-shadow-container no-padding">
                        <div class="row position-relative justify-content-center no-gutters">
                            <div class="col-12">
                                <div class="summary-item achievable_weight">
                    ...
                    <div class="container no-padding similar-calendar-container">
                        <div class="row position-relative justify-content-center row-eq-height">
                            <div class="col-12 col-sm-6">
                                <div class="summary-item inner-shadow-container similar">
                                    <p class="your-status"><span class="text-value">87%</span></p>
                                    <p class="description text-center">Similar people lost<br />more than <span class="red-color font-weight-bold">10</span> lbs<br class="d-none d-sm-block"> on Keto.</p>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="summary-item inner-shadow-container first-week mt-3 mt-sm-0">
                                    <div class="calendar">
                                        <p class="curr-month"></p>
                                        <table>
                                            <tr>
                                                <th>M<span class="d-none d-sm-inline-block">ON</span></th>
                                                <th>T<span class="d-none d-sm-inline-block">UE</span></th>
                                                <th>W<span class="d-none d-sm-inline-block">ED</span></th>
                                                <th>T<span class="d-none d-sm-inline-block">HU</span></th>
                                                <th>F<span class="d-none d-sm-inline-block">RI</span></th>
                                                <th>S<span class="d-none d-sm-inline-block">AT</span></th>
                                                <th class="red-color">SUN</th>
                                            </tr>
                                            <tr class="dates">
                                                <td>1</td>
                                                <td>2</td>
                                    ...
                                    <p class="your-status"><span class="text-value">-5</span><span class="text-unit red-color font-italic font-weight-bold">lbs</span></p>
                                    <p class="description text-center">After first week</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container inner-shadow-container no-padding">
                        <div class="row position-relative justify-content-center no-gutters">
                            <div class="col-12">
                                <div class="summary-item bmi">
                                    <h3>BMI</h3>
                                    <p class="your-status">You are likely: <span class="text-value font-size-base">OVERWEIGHT</span></p>

                                    <p class="description"><span class="number-value">27.10</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container inner-shadow-container no-padding">
                        <div class="row position-relative justify-content-center no-gutters">
                            <div class="col-12">
                                <div class="summary-item body-change">
                                    <h3>BODY CHANGE ESTIMATIONS</h3>
                    ...
                    <div class="container inner-shadow-container no-padding">
                        <div class="row position-relative justify-content-center no-gutters">
                            <div class="col-12">
                                <div class="summary-item metabolic_age">
                                    <h3>METABOLIC AGE</h3>
                    ...
                    <div class="container inner-shadow-container no-padding">
                        <div class="row position-relative justify-content-center no-gutters">
                            ...
                            <div class="col-12">
                                <div class="summary-item keto_compatibility">
                    ...
                    <div class="container inner-shadow-container no-padding">
                        <div class="row position-relative justify-content-center no-gutters">
                            <div class="col-12">
                                <div class="summary-item anxiety_factors">
                    ...
                    <div class="container inner-shadow-container no-padding">
                        <div class="row position-relative justify-content-center no-gutters">
                            <div class="col-12">
                                <div class="summary-item energy_metabolism">
                                    ...
                                    <p class="description active-0">
                                        ...
                                        <span class="more-text">
                                            ...
                                            If eating causes your energy to slow down, it means your metabolism may not not be working as well as it could. 
                    ...
                    <section id="whatyouget" class="container inner-shadow-container no-padding">
                        <div class="container">
                            <div class="row mb-2">
                                <div class="col-12">
                                    <h3>
                                        <span class="red-color">YOUR 28 DAY</span><br />
                                        <span class="blue-color">PERSONALIZED</span><br />
                                        <span class="red-color">KETO MEAL PLAN IS READY!</span>
                                    </h3>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <picture>
                                        <source srcset="<?php echo keycdn_url().'assets/img/';?>sum-img-v4.webp" type="image/webp">
                                            <img class="w-75 mx-auto d-block mb-3" src="<?php echo keycdn_url().'assets/img/';?>sum-img-v4.jpg" alt="">
                                                </picture>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="text-area">
                                                        <div class="item">
                                                            <span><svg class="icon" width="24" height="24"><use xlink:href="#check-circle-solid"></use></svg></span>
                                                            <div class="item-texts">
                                                                <div class="item-text-container">
                                                                    <span class="title">A Personalized 28-Day Meal Plan: </span>
                                                                    <span>You get a comprehensive 28-Day Meal Plan designed specifically to fit YOUR body and YOUR health goals.</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="item">
                                                            ...
                                                            <div class="item-texts">
                                                                <div class="item-text-container">
                                                                    <span class="title">Get Results Quickly & Easily: </span>
                                                                    <span>Each of the suggested recipes in your meal plan are designed to meet your goals — while still allowing for flexibility.</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="item">
                                                            ...
                                                            <div class="item-texts">
                                                                <div class="item-text-container">
                                                                    <span class="title">We’ve Done All The Work For You! </span>
                                                                    <span>No more stressing out over exact measurements. No more trying to figure out what to eat next. We’ve planned and calculated each meal for YOU.</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="item">
                                                            ...
                                                            <div class="item-texts">
                                                                <div class="item-text-container">
                                                                    <span class="title">Time & Budget Friendly: </span>
                                                                    <span>You’ll only use ingredients that you know, like, and are easy on your wallet. And while we use a professional chef to plan out each of the delicious keto meals inside your plan, you don’t need any fancy cooking skills to prepare them yourself. The instructions are clear, simple and make preparation a breeze.</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="item">
                                                            <span><svg class="icon" width="24" height="24"><use xlink:href="#check-circle-solid"></use></svg></span>
                                                            <div class="item-texts" style="border-left: none;">
                                                                <div class="item-text-container">
                                                                    <span class="title">Digital Access On Any Device: </span>
                                                                    <span>Download and access your personalized meal plan anywhere and at any time, on your phone, tablet or computer.</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="row">
                                <div class="col-12 text-center mt-5">
                                    <a href="pricing" class="btn btn-primary offer-badge btn-continue">CLAIM YOUR <br class="mobile-br">MEAL PLAN NOW <svg class="icon" width="32" height="32"><use xlink:href="#double-angle-right"></use></svg></a>
                                </div>
                            </div>
                        </div>
                    </section>
